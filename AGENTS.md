...
`.claude/skills/` (dev-workflow automation) and the repo-root `skills/`
directory (product skills that drive the live `/apps/mcp` tools for
end-user/ChatGPT-style use — see `skills/README.md`) are the two skill
homes and are kept disjoint.
