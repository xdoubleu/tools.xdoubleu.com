...
want_rules="FrontendP95High HostCPUHigh HostDiskHigh HostMemoryHigh IssueFailingPRs IssueMainCIRed IssueOrphanedStorage IssueSecurityAlerts IssueSentryUnresolved JobP95High R2UsageHigh RequestP95High TargetDown TargetMissing"
