...
func (r *IntegrationsRepository) Get(
	...
	err := r.db.QueryRow(ctx, `
		SELECT user_id, todoist_api_key, todoist_project_id,
		       steam_api_key, steam_user_id, goodreads_url
...
func (r *IntegrationsRepository) Upsert(
	...
	_, err := r.db.Exec(ctx, `
		INSERT INTO goaltracker.user_integrations
		    (user_id, todoist_api_key, todoist_project_id,
		     steam_api_key, steam_user_id, goodreads_url, updated_at)
		VALUES ($1, $2, $3, $4, $5, $6, now())
		ON CONFLICT (user_id) DO UPDATE SET
			todoist_api_key    = EXCLUDED.todoist_api_key,
