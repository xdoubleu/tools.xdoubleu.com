...
const goodreadsCSV = `Book Id,Title,Author,ISBN,ISBN13,My Rating,Exclusive Shelf,Bookshelves,Date Read
12345,The Odyssey,Homer,"=""0140449116""","=""9780140449112""",5,read,"read,own-physical",2023/06/15
67890,Dune,Frank Herbert,"=""0441013597""","=""9780441013593""",0,to-read,"to-read,own-digital",
11111,Foundation,Isaac Asimov,,,3,currently-reading,currently-reading,
`
...
func TestParseCSV_EmptyDateRead(t *testing.T) {
	...
	row := "99999,Test Book,Test Author,,,0,read,,"
...
func TestParseCSV_SkipsInvalidBookID(t *testing.T) {
	rows := "not-a-number,Bad Row,Author,,,0,read,,\n99999,Good Book,Author,,,0,read,,"
	entries, err := books.ParseCSV(strings.NewReader(csvHeader + "\n" + rows + "\n"))
	require.NoError(t, err)
