...
import { useSharedSteam } from '@/hooks/useDashboardShare'
import type { GetSharedSteamResponse } from '@/lib/gen/dashboard/v1/games_pb'
...
export default function GamesDashboardPublicLibrary({
  token,
  initialData
}: {
  token: string
