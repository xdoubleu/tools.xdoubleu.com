...
import { GetSharedSteamGameResponseSchema } from '@/lib/gen/dashboard/v1/games_pb'
...
describe('GamesDashboardPublicGameClient', () => {
  ...
  it('links the breadcrumb back to the games profile', () => {
    ...
    expect(links.some((l) => l.getAttribute('href') === '/dashboard/games/tok-1')).toBe(true)
  })
