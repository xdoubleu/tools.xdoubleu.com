...
jest.mock('@/components/reading/LibrarySidebar', () => ({
  buildShelves: jest.fn(),
  buildTags: jest.fn()
}))

import ManageShelvesTagsDialog from '@/components/reading/ManageShelvesTagsDialog'
import type { Shelf } from '@/components/reading/LibrarySidebar'
...
describe('ManageShelvesTagsDialog', () => {
  ...
  it('creates a new shelf and mutates on Add', async () => {
    ...
    await waitFor(() => expect(mockMutate).toHaveBeenCalledWith('/reading'))
  })
