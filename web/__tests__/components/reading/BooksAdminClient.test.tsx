...
jest.mock('@/lib/reading/resyncRefresh', () => ({
...
jest.mock('@/components/reading/ResyncWizard', () => ({
  __esModule: true,
  default: () => <div data-testid="resync-wizard" />
}))

jest.mock('@/components/reading/SourceStats', () => ({
  __esModule: true,
  default: () => <div data-testid="source-stats" />
}))

jest.mock('@/components/reading/ManageDuplicatesDialog', () => ({
  __esModule: true,
