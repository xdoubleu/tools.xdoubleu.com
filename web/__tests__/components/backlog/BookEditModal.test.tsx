...
describe('BookEditModal', () => {
  ...
  it('renders book title and authors', () => {
    render(<BookEditModal userBook={userBook as never} onClose={jest.fn()} onSaved={jest.fn()} />)
  ...
  it('calls onClose when Cancel clicked', () => {
    ...
    render(<BookEditModal userBook={userBook as never} onClose={onClose} onSaved={jest.fn()} />)
  ...
  it('calls updateBookStatus and onSaved on save', async () => {
    ...
    render(<BookEditModal userBook={userBook as never} onClose={onClose} onSaved={onSaved} />)
