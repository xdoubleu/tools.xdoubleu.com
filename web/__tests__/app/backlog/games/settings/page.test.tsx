...
jest.mock('@/hooks/useSettings', () => ({
  ...
  useSaveSettings: () => mockSaveSettings
}))
...
import BacklogGamesSettingsPage from '@/app/backlog/games/settings/page'
...
describe('BacklogGamesSettingsPage', () => {
  ...
  it('renders a breadcrumb link back to /backlog/games', () => {
    render(<BacklogGamesSettingsPage />)
