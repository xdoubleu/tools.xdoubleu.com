...
jest.mock('@/app/learningpaths/[id]/edit/EditLearningPathClient', () => ({
  __esModule: true,
  default: () => <div data-testid="client" />
}))

import Page from '@/app/learningpaths/[id]/edit/page'

describe('EditLearningPathPage', () => {
  it('renders with server-fetched data', async () => {
    fetchOrNull.mockResolvedValue({})
    render(await Page({ params: Promise.resolve({ id: 'lp1' }) }))
