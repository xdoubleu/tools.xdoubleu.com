...
export type Feed = Message<"feeds.v1.Feed"> & {
  ...
  /**
   * @generated from field: string last_modified = 10;
   */
  lastModified: string;
 ...
 *
 * @generated from message feeds.v1.UnhealthyFeed
 */
export type UnhealthyFeed = Message<"feeds.v1.UnhealthyFeed"> & {
  /**
...
/**
 * Describes the message feeds.v1.UnhealthyFeed.
 ...
 */
export type GetUnhealthyFeedsRequest = Message<"feeds.v1.GetUnhealthyFeedsRequest"> & {
};

/**
 * Describes the message feeds.v1.GetUnhealthyFeedsRequest.
...
export const GetUnhealthyFeedsRequestSchema: GenMessage<GetUnhealthyFeedsRequest> = /*@__PURE__*/
  messageDesc(file_feeds_v1_feeds, 23);

/**
 * @generated from message feeds.v1.GetUnhealthyFeedsResponse
 */
export type GetUnhealthyFeedsResponse = Message<"feeds.v1.GetUnhealthyFeedsResponse"> & {
  /**
   * @generated from field: repeated feeds.v1.UnhealthyFeed feeds = 1;
   */
  feeds: UnhealthyFeed[];
};

/**
 * Describes the message feeds.v1.GetUnhealthyFeedsResponse.
...
export const FeedService: GenService<{
  ...
  /**
   * @generated from rpc feeds.v1.FeedService.GetUnhealthyFeeds
   */
  getUnhealthyFeeds: {
    methodKind: "unary";
