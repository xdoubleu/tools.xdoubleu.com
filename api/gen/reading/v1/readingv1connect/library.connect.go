...
const (
	...
	LibraryServiceName = "reading.v1.LibraryService"
)
...
const (
	...
	LibraryServiceUpdateReadingProgressProcedure = "/reading.v1.LibraryService/UpdateReadingProgress"
	...
	// RenameShelf RPC.
	LibraryServiceRenameShelfProcedure = "/reading.v1.LibraryService/RenameShelf"
	// LibraryServiceDeleteShelfProcedure is the fully-qualified name of the LibraryService's
	// DeleteShelf RPC.
	LibraryServiceDeleteShelfProcedure = "/reading.v1.LibraryService/DeleteShelf"
	// LibraryServiceRenameTagProcedure is the fully-qualified name of the LibraryService's RenameTag
	// RPC.
	LibraryServiceRenameTagProcedure = "/reading.v1.LibraryService/RenameTag"
	// LibraryServiceDeleteTagProcedure is the fully-qualified name of the LibraryService's DeleteTag
	// RPC.
	LibraryServiceDeleteTagProcedure = "/reading.v1.LibraryService/DeleteTag"
)

// LibraryServiceClient is a client for the reading.v1.LibraryService service.
...
// NewLibraryServiceClient constructs a client for the reading.v1.LibraryService service. By
...
func NewLibraryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) LibraryServiceClient {
	...
	libraryServiceMethods := v1.File_reading_v1_library_proto.Services().ByName("LibraryService").Methods()
	return &libraryServiceClient{
		...
		createShelf: connect.NewClient[v1.CreateShelfRequest, v1.CreateShelfResponse](
			...
			connect.WithSchema(libraryServiceMethods.ByName("CreateShelf")),
			connect.WithClientOptions(opts...),
		),
...
// GetLibrary calls reading.v1.LibraryService.GetLibrary.
...
// GetBooksProgress calls reading.v1.LibraryService.GetBooksProgress.
...
// SearchLibrary calls reading.v1.LibraryService.SearchLibrary.
...
// SearchExternal calls reading.v1.LibraryService.SearchExternal.
...
// GetExternalBook calls reading.v1.LibraryService.GetExternalBook.
...
// CreateBook calls reading.v1.LibraryService.CreateBook.
...
// AddBookByURL calls reading.v1.LibraryService.AddBookByURL.
...
// UpdateBookStatus calls reading.v1.LibraryService.UpdateBookStatus.
...
// UpdateFinishedAt calls reading.v1.LibraryService.UpdateFinishedAt.
...
// UpdateProgress calls reading.v1.LibraryService.UpdateProgress.
...
// ToggleTag calls reading.v1.LibraryService.ToggleTag.
...
// RemoveBook calls reading.v1.LibraryService.RemoveBook.
...
// UpdateReadingProgress calls reading.v1.LibraryService.UpdateReadingProgress.
...
// GetReadingState calls reading.v1.LibraryService.GetReadingState.
...
// RenameShelf calls reading.v1.LibraryService.RenameShelf.
...
// DeleteShelf calls reading.v1.LibraryService.DeleteShelf.
...
// RenameTag calls reading.v1.LibraryService.RenameTag.
...
// DeleteTag calls reading.v1.LibraryService.DeleteTag.
...
// LibraryServiceHandler is an implementation of the reading.v1.LibraryService service.
...
func NewLibraryServiceHandler(svc LibraryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/reading.v1.LibraryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLibraryServiceHandler) GetLibrary(context.Context, *connect.Request[v1.GetLibraryRequest]) (*connect.Response[v1.GetLibraryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.GetLibrary is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) GetBooksProgress(context.Context, *connect.Request[v1.GetBooksProgressRequest]) (*connect.Response[v1.GetBooksProgressResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.GetBooksProgress is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) SearchLibrary(context.Context, *connect.Request[v1.SearchLibraryRequest]) (*connect.Response[v1.SearchLibraryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.SearchLibrary is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) SearchExternal(context.Context, *connect.Request[v1.SearchExternalRequest]) (*connect.Response[v1.SearchExternalResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.SearchExternal is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) GetExternalBook(context.Context, *connect.Request[v1.GetExternalBookRequest]) (*connect.Response[v1.GetExternalBookResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.GetExternalBook is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) CreateBook(context.Context, *connect.Request[v1.CreateBookRequest]) (*connect.Response[v1.CreateBookResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.CreateBook is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) AddBookByURL(context.Context, *connect.Request[v1.AddBookByURLRequest]) (*connect.Response[v1.AddBookByURLResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.AddBookByURL is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) UpdateBookStatus(context.Context, *connect.Request[v1.UpdateBookStatusRequest]) (*connect.Response[v1.UpdateBookStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.UpdateBookStatus is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) UpdateFinishedAt(context.Context, *connect.Request[v1.UpdateFinishedAtRequest]) (*connect.Response[v1.UpdateFinishedAtResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.UpdateFinishedAt is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) UpdateProgress(context.Context, *connect.Request[v1.UpdateProgressRequest]) (*connect.Response[v1.UpdateProgressResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.UpdateProgress is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) ToggleTag(context.Context, *connect.Request[v1.ToggleTagRequest]) (*connect.Response[v1.ToggleTagResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.ToggleTag is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) RemoveBook(context.Context, *connect.Request[v1.RemoveBookRequest]) (*connect.Response[v1.RemoveBookResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.RemoveBook is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) UpdateReadingProgress(context.Context, *connect.Request[v1.UpdateReadingProgressRequest]) (*connect.Response[v1.UpdateReadingProgressResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.UpdateReadingProgress is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) CreateShelf(context.Context, *connect.Request[v1.CreateShelfRequest]) (*connect.Response[v1.CreateShelfResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.CreateShelf is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) RenameShelf(context.Context, *connect.Request[v1.RenameShelfRequest]) (*connect.Response[v1.RenameShelfResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.RenameShelf is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) DeleteShelf(context.Context, *connect.Request[v1.DeleteShelfRequest]) (*connect.Response[v1.DeleteShelfResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.DeleteShelf is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) RenameTag(context.Context, *connect.Request[v1.RenameTagRequest]) (*connect.Response[v1.RenameTagResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.RenameTag is not implemented"))
}
...
func (UnimplementedLibraryServiceHandler) DeleteTag(context.Context, *connect.Request[v1.DeleteTagRequest]) (*connect.Response[v1.DeleteTagResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reading.v1.LibraryService.DeleteTag is not implemented"))
}
