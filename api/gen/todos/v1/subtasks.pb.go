...
const file_todos_v1_subtasks_proto_rawDesc = "" +
	...
	"\x15ToggleSubtaskResponse\x12+\n" +
	"\asubtask\x18\x01 \x01(\v2\x11.todos.v1.SubtaskR\asubtask\"N\n" +
	"\x14DeleteSubtaskRequest\x12\x1d\n" +
	"\n" +
	"subtask_id\x18\x01 \x01(\tR\tsubtaskId\x12\x17\n" +
	"\atask_id\x18\x02 \x01(\tR\x06taskId\"\x17\n" +
	"\x15DeleteSubtaskResponse\"o\n" +
	"\x16ReorderSubtasksRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x10\n" +
	"\x03ids\x18\x02 \x03(\tR\x03ids\x12*\n" +
	"\x11parent_subtask_id\x18\x03 \x01(\tR\x0fparentSubtaskId\"\x19\n" +
	"\x17ReorderSubtasksResponse\"\xef\x01\n" +
	"\x14UpdateSubtaskRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x1d\n" +
	"\n" +
	"subtask_id\x18\x02 \x01(\tR\tsubtaskId\x12\x14\n" +
	...
	"\rUpdateSubtask\x12\x1e.todos.v1.UpdateSubtaskRequest\x1a\x1f.todos.v1.UpdateSubtaskResponseB)Z'tools.xdoubleu.com/gen/todos/v1;todosv1b\x06proto3"
