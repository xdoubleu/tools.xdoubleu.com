...
func (h *booksConnectHandler) AddBookByURL(
	ctx context.Context,
	req *connect.Request[booksv1.AddBookByURLRequest],
) (*connect.Response[booksv1.AddBookByURLResponse], error) {
	...
	return connect.NewResponse(&booksv1.AddBookByURLResponse{
