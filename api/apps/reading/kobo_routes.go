...
func (app *Reading) koboRoutes(prefix string, mux *http.ServeMux) {
...
func (app *Reading) koboAuth(w http.ResponseWriter, r *http.Request) (string, bool) {
...
func (app *Reading) koboInitHandler(w http.ResponseWriter, r *http.Request) {
...
func (app *Reading) koboLibrarySyncHandler(w http.ResponseWriter, r *http.Request) {
...
func (app *Reading) koboProxyHandler(w http.ResponseWriter, r *http.Request) {
	if _, ok := app.koboAuth(w, r); !ok {
		return
	}
...
func (app *Reading) koboFetchUpstreamSync(
	r *http.Request,
...
// handler).
func (app *Reading) koboMetadataHandler(w http.ResponseWriter, r *http.Request) {
	userID, ok := app.koboAuth(w, r)
	if !ok {
		return
	}
...
func (app *Reading) koboFileHandler(w http.ResponseWriter, r *http.Request) {
	userID, ok := app.koboAuth(w, r)
	if !ok {
		return
	}
...
func (app *Reading) koboGetStateHandler(w http.ResponseWriter, r *http.Request) {
	userID, ok := app.koboAuth(w, r)
	if !ok {
		return
	}
...
func (app *Reading) koboPutStateHandler(w http.ResponseWriter, r *http.Request) {
	userID, ok := app.koboAuth(w, r)
	if !ok {
		return
	}
...
func (app *Reading) koboLibraryBase(r *http.Request) string {
