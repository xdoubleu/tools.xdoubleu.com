...
func TestConnectEnableKoboSync_InvalidBookID(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.EnableKoboSyncRequest{BookId: "bad-id"})
	req.Header().Set("Cookie", accessToken.String())
...
func TestConnectGetKEPUBStatus_NoFiles(t *testing.T) {
	...
	req := connect.NewRequest(
		&readingv1.GetKEPUBStatusRequest{BookId: book.ID.String()},
	)
	req.Header().Set("Cookie", accessToken.String())
...
func TestConnectGetKEPUBStatus_EPUBAndKEPUBReady(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.GetKEPUBStatusRequest{BookId: bookID.String()})
	req.Header().Set("Cookie", accessToken.String())
...
func TestConnectGetKEPUBStatus_InvalidBookID(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.GetKEPUBStatusRequest{BookId: "not-a-uuid"})
	req.Header().Set("Cookie", accessToken.String())
...
func TestCreateKoboDevice_AndLookup(t *testing.T) {
	...
	t.Cleanup(func() {
		_, _ = testDB.Exec(ctx,
			`DELETE FROM reading.kobo_devices WHERE user_id = $1`, ownerID)
	})
...
func TestRegisterKoboDevice_RawTokenNeverStoredAndLookupWorks(t *testing.T) {
	...
	err = testDB.QueryRow(ctx,
		`SELECT COUNT(*) FROM reading.kobo_devices
...
func TestConnectRegisterKoboDevice_ReturnsDeviceAndToken(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.RegisterKoboDeviceRequest{
		Name:   "My Kobo Touch",
		Serial: "N418ABCD1234",
	})
	req.Header().Set("Cookie", accessToken.String())
...
func TestConnectRegisterKoboDevice_TokenLookupAfterRegister(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.RegisterKoboDeviceRequest{Name: "Lookup Test"})
	req.Header().Set("Cookie", accessToken.String())
...
func TestConnectListKoboDevices_ReturnsRegisteredDevices(t *testing.T) {
	...
	for _, name := range []string{"Kobo 1", "Kobo 2"} {
		regReq := connect.NewRequest(&readingv1.RegisterKoboDeviceRequest{Name: name})
		regReq.Header().Set("Cookie", accessToken.String())
		_, err := client.RegisterKoboDevice(ctx, regReq)
		require.NoError(t, err)
	}

	listReq := connect.NewRequest(&readingv1.ListKoboDevicesRequest{})
...
func TestConnectDisconnectKoboDevice_RemovesDevice(t *testing.T) {
	...
	regReq := connect.NewRequest(
		&readingv1.RegisterKoboDeviceRequest{Name: "To Remove"},
	)
	regReq.Header().Set("Cookie", accessToken.String())
	...
	// Disconnect it.
	discReq := connect.NewRequest(&readingv1.DisconnectKoboDeviceRequest{Id: deviceID})
...
func TestConnectDisconnectKoboDevice_InvalidID(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.DisconnectKoboDeviceRequest{Id: "not-a-uuid"})
	req.Header().Set("Cookie", accessToken.String())
...
func TestConnectDisconnectKoboDevice_NotFound(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.DisconnectKoboDeviceRequest{
		Id: uuid.NewString(),
	})
	req.Header().Set("Cookie", accessToken.String())
...
func TestConnectRequestKEPUBConversion_PDFOnly_ReturnsConverting(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.RequestKEPUBConversionRequest{
		BookId: bookID.String(),
	})
	req.Header().Set("Cookie", accessToken.String())
...
func TestConnectRequestKEPUBConversion_InvalidBookID(t *testing.T) {
	...
	req := connect.NewRequest(
		&readingv1.RequestKEPUBConversionRequest{BookId: "bad-id"},
	)
	req.Header().Set("Cookie", accessToken.String())
