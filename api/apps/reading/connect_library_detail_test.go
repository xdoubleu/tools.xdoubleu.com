...
func TestConnectGetLibrary_WithVariousBooksAndShelves(t *testing.T) {
	...
	readingReq := connect.NewRequest(&readingv1.UpdateBookStatusRequest{
	...
	readReq := connect.NewRequest(&readingv1.UpdateBookStatusRequest{
...
func TestConnectUpdateBookStatus_ZeroRating(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.UpdateBookStatusRequest{
...
func TestConnectUpdateFinishedAt_OverwritesDates(t *testing.T) {
	...
	setReq := connect.NewRequest(&readingv1.UpdateFinishedAtRequest{
		BookId:     book.BookID.String(),
	...
	getReq := connect.NewRequest(
		&readingv1.SearchLibraryRequest{Query: "FinishedAtEditBook"},
	)
	...
	replaceReq := connect.NewRequest(&readingv1.UpdateFinishedAtRequest{
		BookId:     book.BookID.String(),
	...
	// Clear entirely.
	clearReq := connect.NewRequest(&readingv1.UpdateFinishedAtRequest{
		BookId: book.BookID.String(),
	})
...
func TestConnectUpdateFinishedAt_InvalidDate(t *testing.T) {
	...
	req := connect.NewRequest(&readingv1.UpdateFinishedAtRequest{
		BookId:     book.BookID.String(),
