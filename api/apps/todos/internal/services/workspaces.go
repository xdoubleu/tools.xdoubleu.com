...
// workspacesRepo is the storage surface WorkspacesService needs. It is
// satisfied by repositories.WorkspacesRepository and by fakes in unit tests.
type workspacesRepo interface {
	ListByUser(ctx context.Context, userID string) ([]models.Workspace, error)
	Create(ctx context.Context, w models.Workspace) (*models.Workspace, error)
