...
var appsToolNames = []string{
	...
	"get_failing_pull_requests", "get_security_alerts", "get_failing_main_runs",
	"get_sentry_issues", "resolve_sentry_issue", "get_deploy_status",
...
func TestAppsMCPReadToolsReturnData(t *testing.T) {
	...
	tools := []string{
		...
		"get_failing_pull_requests", "get_security_alerts", "get_failing_main_runs",
		"get_sentry_issues", "get_deploy_status", "get_deploy_logs",
