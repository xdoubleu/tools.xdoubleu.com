...
adds the 13 unprefixed admin-gated observability tools on top, sharing the
exact same internal methods the Connect handlers use — 12 are read, plus
