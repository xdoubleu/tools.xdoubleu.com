...
| [adr-0024](adr-0024-unattended-routine-permission-mode.md) | Unattended routines run with permissions bypassed at the trigger (a per-routine claude.ai routines UI setting), not via a broader repo-wide `.claude/settings.json` allowlist | #1745 |
