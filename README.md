...
- **learningpaths** — Self-directed learning curricula: a path (title, goal, recurring-routine description) made of ordered modules, each with ordered items you check off as you progress, plus a freeform resources list. Scoped per-user, no family sharing. This is the foundational slice (issue #1472) of epic #1471 — MCP write tools, books/feeds resource linking, and Todoist integration land in later, independent PRs.
